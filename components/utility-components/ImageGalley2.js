...
export default function ImageGalley2({images}) {
  ...
  return (
    <div className="row">
      <div className="col-12 col-md-6">
        ...
        <div className="rounded-4 overflow-hidden shadow mt-3">
          <Image src={images.imageTwo} layout="responsive" alt="..." priority />
        </div>
      </div>
      <div className="col-12 col-md-6">
        <div className="rounded-4 mt-3 mt-md-0 overflow-hidden shadow">
          <Image src={images.imageThree} layout="responsive" alt="..." priority />
        </div>
        <div className="rounded-4 overflow-hidden mt-3 shadow">
